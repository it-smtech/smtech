...
class Board extends React.Component {
  ...
  filterPositions(playerPositions, index) {
    return this.props.players.filter((player, filterIndex) => {
      return (
  ...
  render() {
    ...
    const squareNodes = p.squares.map((array, index) => {
      ...
      const playersArray = playerPositions.includes(index)
        ? this.filterPositions(playerPositions, index)
        : null;
    ...
    return (
      <div className="board">
        ...
        <div className="board-row">
          ...
          <div className="box inner content-large">
            <PropertyStats property={p.property} />
          </div>
        ...
        <div className="board-row">
          ...
          <div className="box inner filler-small"></div>
          <div className="box inner content-small">
            <Buy handleClick={p.purchaseClick} />
          </div>
          <div className="box inner filler-medium"></div>
          <div className="box inner content-small">
            <Escape handleClick={p.escapeClick} />
          </div>
          <div className="box inner filler-medium"></div>
        ...
        <div className="board-row">
          ...
          <div className="box inner filler-small"></div>
          <div className="box inner content-small">
            <End updateActivePlayer={p.updateActivePlayer} />
          </div>
          <div className="box inner filler-medium"></div>
