...
class PlayerStats extends React.Component {
  ...
  setSelectedProperty() {
    if (this.props.player && this.props.player.properties) {
      this.setState({
        selectedProperty:
          this.props.player.properties[this.state.selectedPropertyIndex],
      });
    }
  }

  flipModalState() {
    this.setState({ showModal: !this.state.showModal, selectedProperty: null });
  }
