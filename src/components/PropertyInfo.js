...
class PropertyInfo extends React.Component {
  ...
  render() {
    ...
    if (this.props.property && this.props.property.housePrice) {
      ...
      currentRent =
        this.props.property.rentValues[this.props.property.rentIndex];
    ...
    return (
      <div className="property-info-div">
        ...
        <p>
          <b>No. properties in group owned:</b> {count}
        </p>
        <p>
          <b>Current development level:</b> {currentHouses}
        </p>
        <p>
          <b>Current rent:</b> {currentRent}
        </p>
        <p>
          <b>Development cost:</b> {price}
        </p>
        <Build player={this.props.player} property={this.props.property} />
      </div>
    );
  }
}
