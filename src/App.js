...
const chance15 = new Card(
  "You are assessed for street repairs: £40 per house, £115 per hotel",
  3
);
const chance16 = new Card(
...
class App extends Component {
  ...
  componentDidMount() {
    client.on("getUserID", (message) => {
      console.log("got reply getUserID", message);
      this.setState((state) => ({
        userID: message.userID,
        roomNumber: message.roomId,
      }));
      client.emit("updateRoomUsers", {
        type: "request",
  ...
  onLoginClicked = (value) => {
    ...
    client.emit("getUserID", {
      type: "request",
      isNewRoom: this.state.checked,
      roomId: this.state.roomNumber,
    });
  };
  onCheckBoxChecked = (e) => {
        ...
        {this.state.isLoggedIn ? (
          ...
          <div style={{ padding: "200px 40px" }}>
            ...
            <Search
              ...
              enterButton="Login"
              size="large"
              onSearch={(value) => this.onLoginClicked(value)}
            /> */}
            <Form
              name="basic"
              labelCol={{
            ...
            >
              {!this.state.checked ? (
                <div>
                  ...
                  >
                    <Input placeholder="Enter the room number" size="large" />
                  </Form.Item>
                </div>
              ) : (
                <Form.Item
