...
const arrayFeature = [
  {
    title: "Mission",
    desc: "Our main mission is to support out customers in the development of their IT systems",
  },
  {
    title: "Vision",
  ...
  {
    title: "Values",
    desc: `We keep our promises and are committed to doing buisiness the right way,      
      ...
      <main>
        <section ref={aboutUsRef} className="row m-0">
          ...
          <div className="col-md-6 background-black">
            <h2>
              Our main mission is to support out customers in the development of
              their IT systems.
              <br />
              Our vision is to create a better relationship between customers
              and IT services providers.
              <br />
              We keep our promises and are committed to doing buisiness the
              right way, We provide quality products and services tham meet our
              customers needs and We encourage innovation to meet challenges.
            </h2>
          </div>
        ...
        <section ref={offersRef} className="background-primary row m-0">
          ...
          <div className="col-md-6 background-black">
            <h2>
              SMTech has a good expertise in the domaine of web development.
              <br />
        ...
        <section ref={servicesRef} className="row m-0">
          ...
          <div className="col-md-6 background-black">
            <h2>
              ...
              development.
              <br />
              We can help you preparing fonctional needs as well as to develop a
              full application.
              <br />
              Our exprimented enfineers will be delighted to provide you the
